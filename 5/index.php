...
<body>
  ...
  <div class="content">
    ...
    <p>
      ...
      PAYSURU+αは月額利用料が6,500円！それ以外にかかる費用は一切ありません！
    </p>
    ...
    <h2>事例</h2>
    <p>PAYSURU+αの活用事例です。低コスト低リスクでお客様の目標達成に大きく貢献しています。</p>
    ...
    <div class="voice">
      <dl>
        ...
        <dd>今までは媒体の追加オプションのサイトを使用していましたが、月額コストが2万円以上を支払っていました。
          ...
          しかし、PAYSURU+αならコストが今ままでの半額以下で、集客1本で元が取れる計算なので、
      ...
      <dl>
        ...
        <dd>
          ...
          PAYSURU+αなら、自分のタイミングで好きな時いつでもページが増やせて、リンクテキストも自動に追加されるのでとても満足しています！
        </dd>
      </dl>
    </div>
    ...
    <div class="faq">
      ...
      <dl>
        ...
        <dd>
        　はい、出来ます！
          PAYSURU+α申し込み時に、ロゴ制作もオーダーして下さい。
          <a href="">新デザインをオーダーする</a>
          <p><br></p>
          ※注記<br>
          　別途費用はかかりません。<br>
            ロゴデータのお引き渡しはPAYSURU+αの初月請求のご入金確認後になります。<br>
            デザイン案は一つです。<br>
