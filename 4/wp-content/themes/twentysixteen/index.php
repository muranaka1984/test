...
<div class="h1bg">
  <p class="h1bg_title">
    <span>北海道の広大な大地から生まれる</span><span>素晴らしい食材をお届けします。</span>
  </p>
...
<div class="content">
  ...
  <a href="<?php echo home_url(); ?>/blog/agricultural/" class="item">
    <dl>
      <dt>農産物</dt>
      <dd>
        野菜・果物
  ...
  <a href="<?php echo home_url(); ?>/blog/livestock/" class="item">
    <dl>
    <dt>畜産物</dt>
      <dd>
        牛肉・豚肉・鶏肉・鹿・ラム
  ...
  <a href="<?php echo home_url(); ?>/blog/marine/" class="item">
    <dl>
      <dt>水産物</dt>
      <dd>
        鮮魚・カニ・エビ・貝
  ...
  <a href="<?php echo home_url(); ?>/blog/processing/" class="item">
    <dl>
      <dt>加工品</dt>
      <dd>
        麺・乳製品・農水畜加工品
...
<?php query_posts('post_type=news&posts_per_page=5&order=DESC'); ?>
<?php if(have_posts()): ?>
