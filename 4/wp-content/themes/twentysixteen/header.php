  ...
  <div class="header">
    <div class="header_content">
      ...
      <ul class="gnavi">
        ...
        <li class="nlink"><a href="<?php echo home_url(); ?>/blog/">ブログ</a></li>
      ...
      <p class="icon_mail">
        <a href="<?php echo site_url(); ?>/contact/"><img src="<?php echo get_template_directory_uri(); ?>/img/icon_mail.png" alt="メール" width="40"></a>
      </p>
    </div>
  </div>
  <!--HEADER-->
